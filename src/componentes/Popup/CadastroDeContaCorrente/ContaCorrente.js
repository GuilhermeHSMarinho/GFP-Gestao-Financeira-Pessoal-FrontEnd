...
const ContaCorrentePopup = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="popupContaCorrente">
            <div className="popup-contentContaCorrente" ref={popupRef}>
                <span className="closeContaCorrente" onClick={onClose}>&times;</span>
                <h2>Cadastro de Conta Corrente</h2>
                <form onSubmit={handleSubmit}>
                    <div className="input-groupContaCorrente">
                        <label>Banco:</label>
                    ...
                    <div className="button-containerContaCorrente">
                        <button className="cancel-btnContaCorrente" type="button" onClick={onClose}>Cancelar</button>
                        <button className="submit-btnContaCorrente" type="submit" disabled={loading}>
                            {loading ? <FontAwesomeIcon icon={faSpinner} spin /> : 'Cadastrar'}
                        </button>
                    </div>
                </form>

                {loading && <div className="loading-messageContaCorrente">Enviando...</div>}

                {(success || error) && (
                    <div className="overlay-iconContaCorrente">
                        <FontAwesomeIcon icon={success ? faThumbsUp : faThumbsDown} size="4x" color="#000" />
                        <div className="feedback-messageContaCorrente">
...
export default ContaCorrentePopup;
